...
<script>
import NewAliasDialog from '@/components/dialogs/NewAliasDialog'
import DeleteAliasDialog from '@/components/dialogs/DeleteAliasDialog'
...
export default {
    ...
    async asyncData({ app: { $axios } }) {
        let { data } = await $axios.$get('/virtual-aliases')
